        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="hover:text-blue-400 transition-colors">Study Planning</Link></li>
              <li><Link to="/" className="hover:text-blue-400 transition-colors">Collaboration Tools</Link></li>
              <li><Link to="/" className="hover:text-blue-400 transition-colors">Content Summarization</Link></li>
              <li><Link to="/" className="hover:text-blue-400 transition-colors">Interactive Quizzes</Link></li>
            </ul>
          </div>
